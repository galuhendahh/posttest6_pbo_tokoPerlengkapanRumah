...
public class Furniture {
    ...
    public ArrayList<Furniture> getFList() {
        return FList;
    }
    ...
    protected void tampilProduk(){
        ...
        for (int i=0; i<FList.size(); i++){
            System.out.println("No Kode Produk : " + kodeF + FList.get(i).getNoKodeF());
    ...
    public ArrayList<Furniture> ubahProduk(ArrayList<Furniture> Flist) {
        int ubah;
